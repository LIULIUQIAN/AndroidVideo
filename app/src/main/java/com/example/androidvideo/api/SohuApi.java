...
import com.example.androidvideo.model.sohu.DetailResult;
import com.example.androidvideo.model.sohu.Result;
import com.example.androidvideo.model.sohu.ResultAlbum;
import com.example.androidvideo.model.sohu.Video;
import com.example.androidvideo.model.sohu.VideoList;
import com.example.androidvideo.model.sohu.VideoResult;
    ...
    public void doGetChannelAlbumsByUrl(final String url, final OnGetChannelAlbumListener listener) {
        OKHttpUtils.excute(url, new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                // 3、Album存到AlbumLis中
                Result result = AppManager.getmGson().fromJson(response.body().string(), Result.class);
    ...
    public void onGetAlbumDetail(final Album album, final OnGetAlbumDetailListener listener) {
        ...
        OKHttpUtils.excute(url, new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                //Data
                DetailResult result = AppManager.getmGson().fromJson(response.body().string(),  DetailResult.class);
...
//                Log.d(TAG, " >> onGetVideo response  " + response.body().string());
                VideoResult result = AppManager.getmGson().fromJson(response.body().string(), VideoResult.class);
                if (result != null) {
